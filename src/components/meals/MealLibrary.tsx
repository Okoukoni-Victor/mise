...
const slotFilters: { value: SlotFilter; label: string }[] = [
  { value: "all", label: "All" },
...
export default function MealLibrary() {
  ...
  return (
    <main className="px-[20px] md:px-[48px] py-[28px] md:py-[40px]">
        ...
        {hasMeals && (
          <>
            <p className="mt-[6px] text-[14px] text-[var(--color-muted)]">
              {store.meals.length} meal{store.meals.length > 1 ? "s" : ""} saved
            </p>

            <button
              type="button"
              onClick={openAddModal}
              className="select-none cursor-pointer inline-flex shrink-0 items-center gap-[7px]
            w-fit mt-[16px] rounded-[10px] px-[20px] py-[11px] bg-green-600 text-[14px]
            font-semibold text-white transition-colors duration-150 hover:bg-green-800"
            >
      ...
      {/* Search + filter bar (only when meals exist) */}
      {hasMeals && (
          ...
          <div className="relative flex-1 min-w-[180px]">
            ...
            <input
              ...
              className="w-full border-[1.5px] border-[var(--color-border)] rounded-[8px]
                pl-[34px] pr-[12px] py-[9px] text-[14px] bg-[var(--color-surface)]
              ...
              return (
                <button
                  ...
                  className={`select-none cursor-pointer border-[1.5px] rounded-[8px]
                    px-[14px] py-[8px] text-[13px] transition-all duration-150
                    ${
                      active
      ...
      {!hasMeals ? (
        ...
        <div className="flex flex-col items-center gap-[14px] px-[20px] py-[64px]">
          ...
          <button
            ...
            className="select-none cursor-pointer bg-transparent underline text-[14px]
