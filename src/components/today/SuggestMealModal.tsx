  ...
  return (
    <Dialog open={isOpen} onClose={onClose} className="relative z-modal">
      ...
      <div className="fixed inset-0 flex justify-center items-center">
        <DialogPanel
          transition
          className="overflow-hidden w-full max-w-[480px] rounded-[16px]
        ...
        >
          ...
          <div
            className="border-b border-[var(--color-border)] px-[24px] pt-[24px]
              pb-[18px]"
          >
            <div className="flex justify-between items-start gap-[24px] mb-[16px]">
              <div>
                <DialogTitle
                  className="mb-[4px] tracking-[0.08em] text-[11px] font-body
                    uppercase font-semibold text-salmon-600"
                >
                  Suggest a meal
                </DialogTitle>

                <Description
                  className="leading-[1.2] text-[18px] md:text-[20px]
                    font-display font-bold text-[var(--color-foreground)]"
                >
                  Let Mise decide
                </Description>
              </div>
                ...
                return (
                  <button
                    ...
                    className={`select-none cursor-pointer flex-1 border-[1.5px]
                      rounded-[8px] py-[9px] text-[13px] font-semibold 
                      ...
                      ${
                        active
                          ...
                          : `border-[var(--color-border)] bg-[var(--color-background)]
                             text-[var(--color-muted)] hover:bg-green-50
            ...
            {status === "idle" && (
              <div className="flex flex-col items-center px-[8px] py-[20px] text-center">
                ...
                <p className="max-w-[320px] mb-[20px] leading-[1.6] text-[15px] text-[var(--color-muted)]">
                  Mise will look at your meals, your pantry, and the rest of
                  your week, then pick the best {slotLabel.toLowerCase()} for
                  you — or invent one if nothing fits.
                </p>
